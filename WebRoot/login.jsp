...
<html>
  <head>
	...
	<meta http-equiv="description" content="This is my JSP page">
  ...
  <body onload="init()">
    <div align="center">
    	<form method="post" name="myform" action="user/user_login" onsubmit="login()">
    			...
    			<tbody>
    				...
    				<tr>
    					...
    					<td>&nbsp;
    						...
    						<input id="password2" type="password" name="admin.pwd">
    					</td>
    				</tr>
    				<tr>
    					<td>&nbsp;用户类型</td>
