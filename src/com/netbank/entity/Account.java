...
public class Account  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Account(Status status, String username, String password, BigDecimal balance) {
        this.status = status;
    ...
    /** full constructor */
    public Account(Status status, String username, String password, BigDecimal balance, Set personinfos, Set transactionLogs) {
        this.status = status;
        this.username = username;
        this.password = password;
        this.balance = balance;
